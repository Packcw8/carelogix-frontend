    ...
    >
      ...
      <div>
        ...
        <select
          ...
          value={formData.safety_checkbox || ""}
          onChange={handleSelectChange}
          className="w-full border rounded px-3 py-1"
        >
          <option value="">-- Select --</option>
          <option value="*">* Safety Concerns</option>
      ...
      <div>
        <label className="block font-medium">Location Observed</label>
        <select
          name="location_checkbox"
          value={formData.location_checkbox || ""}
          onChange={handleSelectChange}
          className="w-full border rounded px-3 py-1"
        >
          <option value="">-- Select --</option>
